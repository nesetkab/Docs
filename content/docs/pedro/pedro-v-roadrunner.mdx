...
| Path Type | Parametric Splines | Bezier curves |
...
| Best For | Consistency and Predicability | Speed, Accuracy and Localization |
...
| Command Integration | Built-in (Actions) | External (FTCLib, SolversLib, NextFTC) |