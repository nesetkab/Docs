...
Custom Curves **must** be twice differentiable and parameterized on the interval [0,1].
There is a optional initialization method that can be overridden to do something on the creation of the curve.
