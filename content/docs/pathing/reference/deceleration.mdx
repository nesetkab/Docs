...
### Global Deceleration
This allows deceleratation based on a entire PathChain and not only the last path of the chain. This is especially useful if the last path in the chain is short.
