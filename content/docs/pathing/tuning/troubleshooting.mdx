...
<Accordions type="single">
    ...
    <Accordion title="Cannot See the Constants in Panels">
        If the Tuning class dropdown in the Panels Configurables is empty, double check that you have selected an OpMode in the Tuning OpMode using the gamepad before reloading the Panels website.
    </Accordion>
</Accordions>