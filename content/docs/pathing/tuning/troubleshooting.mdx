...
<Accordions type="single">
    ...
    <Accordion title="Robot turns 180 and oscillates during HeadingTuner">
    ...
    <Accordion title="Cannot see the Follower or Constants in the Tuning Class through Panels">
        Double check that you have selected an OpMode in the Tuning OpMode using the gamepad before reloading the Panels website.
    </Accordion>
</Accordions>