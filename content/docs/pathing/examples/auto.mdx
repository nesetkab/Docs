...
The `pathState` variable will track the robot's movement throughout the autonomous. Each state in `autonomousPathUpdate()` colerates to 
...
premature execution and allow you to incorperate your subsystems.
